              ...
              <v-form ref="addcollegeform" lazy-validation>
                <v-container grid-list-md>
                  <v-layout wrap>
                    <v-flex md12>
                      <v-select
                        :items="collegeTypes_select"
                        item-text="text"
                        item-value="value"
                        v-model="addcollege.collegeType"
                        label="college Type"
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="Firstname"
                        v-model="addcollege.collegeFirstname"
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="Lastname"
                        v-model="addcollege.collegeLastname"
                        prepend-icon="mdi-account-box"
                        required
                        :rules="[(v) => !!v || '']"
                        rounded
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="เบอร์โทร"
                        v-model="addcollege.collegePhone"
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="E-mail"
                        v-model="addcollege.collegeEmail"
                    ...
                    <v-flex
                      xs12
                      v-if="
                        addcollege.collegeType == 'MoeProvince' ||
                        addcollege.collegeType == 'VecProvince'
                      "
                    >
                      <v-autocomplete
                        :items="provinces"
                  ...
                  <v-layout wrap class="pa-4">
                    <v-flex xs12>
                      <h2>
                        ...
                        <span class="red--text">{{ editcollege.collegeName }}</span>
                      </h2>
                    </v-flex>
                  </v-layout>
                </v-container>
                  ...
                  <v-layout wrap>
                    <v-flex md12>
                      <v-select
                        ...
                        item-text="text"
                        item-value="value"
                        v-model="editcollege.collegeType"
                        label="college Type"
                        prepend-icon="mdi-account-star"
                        required
                        :rules="[(v) => !!v || '']"
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="Firstname"
                        v-model="editcollege.collegeFirstname"
                        prepend-icon="mdi-account-box"
                        require
                        :rules="[(v) => !!v || '']"
                        rounded
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="Lastname"
                        v-model="editcollege.collegeLastname"
                        prepend-icon="mdi-account-box"
                        required
                        :rules="[(v) => !!v || '']"
                        rounded
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="เบอร์โทร"
                        v-model="editcollege.collegePhone"
                        prepend-icon="mdi-cellphone-basic"
                        required
                        :rules="[(v) => !!v || '']"
                        rounded
                    ...
                    <v-flex md6>
                      <v-text-field
                        label="E-mail"
                        v-model="editcollege.collegeEmail"
                        prepend-icon="mdi-email"
                        required
                        :rules="[(v) => !!v || '']"
                        rounded
                    ...
                    <v-flex
                      xs12
                      v-if="
                        editcollege.collegeType == 'MoeProvince' ||
                        editcollege.collegeType == 'VecProvince'
                      "
                    >
                      <v-autocomplete
                        :items="provinces"
  ...
  methods: {
    ...
    async addcollegeSubmit() {
      if (this.$refs.addcollegeform.validate()) {
        ...
        if (result.data.status == true) {
          ...
          this.collegeQueryAll()
          let collegeSession = JSON.parse(sessionStorage.getItem('college')) || 0
          this.data_syslog.ApiKey = this.ApiKey
          this.data_syslog.college_account = collegeSession.collegeName
          ...
          this.data_syslog.detail_log =
            this.addcollege.collegeName +
            ' ' +
            this.addcollege.collegeFirstname +
            ' ' +
            this.addcollege.collegeLastname
    ...
    async editcollegeSubmit() {
      if (this.$refs.editcollegeform.validate()) {
        ...
        if (this.editcollege.collegePassword == '') delete this.editcollege.collegePassword
