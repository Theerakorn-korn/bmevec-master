<template>
  <div>
    <v-container fluid>
      <v-alert id="alert" dense type="info"> ข้อมูลผู้ใช้งาน </v-alert>
      <v-row no-gutters>     
      ...
      <v-list-item>
        ...
        <v-list-item-content>
          <v-list-item-title>สถานศึกษา : {{ user.collegeName }}</v-list-item-title>       
        </v-list-item-content>
      ...
      <v-list-item>
        ...
        <v-list-item-content>
          <v-list-item-title>ชื่อในการเข้าใช้งาน : {{ user.college_user_username }} </v-list-item-title>
          <v-list-item-title>รหัสผ่าน :  </v-list-item-title>
   ...
   async updateDialog(){
      ...
      if (this.$refs.editcollegeform.validate()) {
        ...
        if (result.data.status == true) {
          ...
          this.data_syslog.user_account = userSession.college_user_id
          this.data_syslog.event_log = 'update'
          this.data_syslog.page_log = 'college_user'
          this.data_syslog.table_log = 'college_user'
          this.data_syslog.detail_log = this.editcollege.college_user_id 
